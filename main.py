...
def text_to_speech(text):
    ...
    engine.runAndWait()  # { why i need to use this line after using engine.say() }
...
def generativeAI_response(prompt):
    try:
        ...
        genai.configure(api_key="AIzaSyD61sbHly8W4pH-2ywZaSB5QPTgLyhh85M")
        # Create the model
        generation_config = {
            "temperature": 1,
            "top_p": 0.95,
        ...
        res = (
            res[:500]
            # + f"<<--for more information read the document which named in your prompt dot t x t-->>"
        )
        return res
    except Exception as e:
...
if __name__ == "__main__":
    ...
    lists = [
        ...
        [
            "translator",
            "https://www.google.com/search?q=translate+in+bengali&rlz=1C1UEAD_enIN999IN999&oq=tran&aqs=chrome.0.35i39j69i57j35i39j0i131i433i512j0i512j0i131i433i512j0i433i512j5.2084j0j7&sourceid=chrome&ie=UTF-8",
        ],
    ]
    apps = [
        ["notepad", "notepad.exe"],
